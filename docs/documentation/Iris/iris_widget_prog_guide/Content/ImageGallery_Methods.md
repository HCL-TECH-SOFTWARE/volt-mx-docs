...
//box1 is a template with 3 labels defined in the templates Tab
      selectedRowIndex:4,
      selectedIndices:\[4,5\],
      viewType:constants.SEGUI\_VIEW\_TYPE\_PAGEVIEW,onSwipe:onSwipeCallBck
};
...
form1.myButton.setVisibility(
    false, {
        "animEffect": constants.ANIMATION\_EFFECT\_COLLAPSE,
        "animDuration": 1,
        "animDelay": 0,
        "animCurve": constants.ANIMATION\_CURVE\_LINEAR,
        "animCallBacks": {
