...
{% highlight voltMx %}​​​​​//Defining the properties for Horizontal Image strip. 
...
var hIS=new hcl.ui.HorizontalImageStrip2
(
  hISBasic,
  hISLayout,
  hISPSP
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[setData](javascript:void(0);)
