...
```
//Sample code to set the onSelection event callback to a Slider widget.

frmSlider.mySlider.onSelection=onSelectionCallBack;
function onSelectionCallBack(slider){
...
```
//Sample code to set the onSlide event callback to a Slider widget.

frmSlider.mySlider.onSlide=onSlideCallBack;
function onSlideCallBack(slider){
  //Write your logic here.
 }
