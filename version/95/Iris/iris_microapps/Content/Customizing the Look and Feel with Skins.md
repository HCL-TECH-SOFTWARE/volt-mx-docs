...
[Copy and Paste a Color or Gradient](Copy and Paste a Color.htmll)

[Using Themes - Applying a Collection of Skins as a Group](Using Themes Applying a Collection of Skins as a Group.htmll)
...
SPA borders can be applied when you have forked a form to the SPA platform. For more information, see [Forking a Form](Forking.htmll#Forking_a_Form).
...
2.  **Color**: To modify the border color, do one of the following:
    ...
    *   Reuse an existing color. For more information, see [Copy and Paste a Color](Copy and Paste a Color.htmll).
...
*   **Color**: Denotes the font color. To modify the font color, do one of the following:
    ...
    *   **Reuse an existing color.** For more information, see [Copy and Paste a Color or Gradient](Copy and Paste a Color.htmll).
