...
*   [voltmx.automation](Iris/iris_api_dev_guide/content/voltmx.automation_namespace.md#waitForLoadingScreenToDismiss)
*   [waitForLoadingScreenToDismiss](Iris/iris_api_dev_guide/content/voltmx.automation_namespace.md#waitForLoadingScreenToDismiss)
...
This release also includes the following developer productivity enhancements:
...
* V9 SP5 introduces the new version of App viewer tablet.
* V9 SP5 introduces the new version of App viewer mobile.
...
Support for iOS 15 & 16 has been added in Volt MX Iris.
...
## App Viewer Support
Added App viewer support for both mobile and tablets.
...
**Added support for JBoss 7.3**

Support to use JBoss 7.3 as the Application Server has been added to the Volt Foundry Installers.

For information about this feature on the Windows installer, click [here](Foundry/voltmx_foundry_windows_install_guide/Content/Installing_JBoss_modes.md).

For information about this feature on the Linux installer, click [here](Foundry/voltmx_foundry_linux_install_guide/Content/Installing_Foundry_on_JBoss.md).
