...
| uploadRequestQueryParams | JSON   | The uploadRequestQueryParams option is used to pass the query parameters in upload network requests.<br> **Note** : The parameter is supported for Windows, Mobile Web, and Desktop Web channels from release version V8 SP4 FP2.<br>The keys and values in the JSON must be of the string data type.<br>This parameter is not supported for Desktop Native channel.| No  |
| downloadRequestQueryParams | JSON   | The downloadRequestQueryParams is used to pass the query parameters in download network requests.<br>**Note** : The parameter is supported for Windows, Mobile Web, and Desktop Web channels from release version V8 SP4 FP2.<br>The keys and values in the JSON must be of the string data type.<br>This parameter is not supported for Desktop Native channel<br>| No  |
