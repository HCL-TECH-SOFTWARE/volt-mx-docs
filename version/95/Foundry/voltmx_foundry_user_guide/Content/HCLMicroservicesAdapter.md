...
3.  In the [](Configure the Service.md#IntSD)[Object Service Definition](ConfigureIntegrationService.md#IntSD) tab, configure the service definition parameters. For more information, refer to the following sections.
