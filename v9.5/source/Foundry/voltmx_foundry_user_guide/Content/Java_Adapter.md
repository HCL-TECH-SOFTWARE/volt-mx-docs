...
> **_Note:_** The `middleware-api-voltmx.jar` helps you to develop a Java adapter. You can download the `middleware-api-voltmx.jar` from Admin Console's download page.  
