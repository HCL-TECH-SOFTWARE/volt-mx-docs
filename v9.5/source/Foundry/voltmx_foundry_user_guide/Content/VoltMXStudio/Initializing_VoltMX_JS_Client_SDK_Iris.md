...
For further details around app versioning, refer to the [ Volt MX Knowledge article: App version support from SDK](https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0083748)
...
*   bodyParams
    ...
    > **_Note:_** Global request parameter type `bodyParams` is not supported for Offline Objects, Metrics, Binary and Logger modules for IDE-Android, iOS platforms.
