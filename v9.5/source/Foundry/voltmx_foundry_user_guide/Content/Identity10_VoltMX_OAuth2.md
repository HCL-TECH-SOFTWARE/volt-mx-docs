...
7.  **Redirect URL on successful authentication**:
    ...
    *   **Allowed URL list**: Select this to use a specific set of URLs on successful authentication.
    ...
    > **_Note:_** "<b>Redirect URL on successful authentication:</b>” is only accessible from within an app.  It is not visible if you access the OAuth2.0 Identity Service from the API Management section in Foundry.
