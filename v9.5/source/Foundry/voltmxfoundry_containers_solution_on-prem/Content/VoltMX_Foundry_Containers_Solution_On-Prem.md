...
All the Docker images built for Volt MX Foundry are built using the Tomcat version 9.0.102-jdk11 as the base image.
...
The docker images will be pulled when you execute the installation scripts in the "HCL Volt MX Foundry Container Installer" found on MHS portal : [https://my.hcl-software.com/downloads/voltmx/foundrycurrent](https://my.hcl-software.com/downloads/voltmx/foundrycurrent)
