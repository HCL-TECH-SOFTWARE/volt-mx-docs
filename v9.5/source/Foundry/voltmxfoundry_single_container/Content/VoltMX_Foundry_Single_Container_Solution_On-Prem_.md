...
All the Docker images built for Volt Foundry are built using the `Tomcat version 9.0.102-jdk11` as the base image.
...
The docker images will be pulled when you execute the installation scripts in the "HCL Volt Foundry Container Installer" found on MHS portal. To download "HCL Volt Foundry Single Container Installer (Docker)", log on to https://my.hcl-software.com/downloads/voltmx/foundrycurrent.
