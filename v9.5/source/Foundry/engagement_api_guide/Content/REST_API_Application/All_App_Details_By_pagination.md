...
|                  | fcmProjectURL           | string                  | Valid FCM Project URL from Firebase application                                                                                             |
|                  | serviceAccountKeyURL    | string                  | Valid URL for FCM service account key                                                                                             |
...
|                  | webFcmProjectURL        | string                  | Valid Web FCM Project URL from Firebase application                                                                                         |
|                  | webServiceAccountKeyURL | string                  | Valid URL for Web FCM service account key                                                                                              |
...
"serviceAccountKeyURL" : "http://<host>:<port>/context/api/v1/applications/downloadServiceAccountKey?appId=xxxxxx",
"appleCertUrl": "",
"appleCertPassPhrase": "",
"appleBundleId": "",
"appleCertExpiry": "",
...
"webServiceAccountKeyURL" : "http://<host>:<port>/context/api/v1/applications/downloadWebServiceAccountKey?appId=xxxxxx",
"windows8ClientId": "",
