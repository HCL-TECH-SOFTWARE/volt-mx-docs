...
10.  Click the **Settings** tab and choose **Android** to display the **Android** screen.
    *   **FCM Project URL and Service Account Key**: Enter the **FCM Project URL** and upload the **Service Account key**. The **FCM Project URL** and **Service Account key** are required to send push notifications to applications.
11.  Click **Test Connectivity with Cloud** to verify the entered key.
    
     ![](Resources/Images/image063_584x421.png)
    
12.  If the Entered **FCM Project URL** and uploaded **Service Account Key** are correct, the system displays the confirmation message that the cloud connection is successful. Click **Ok** to continue.
