...
> **Note:**  
*   Binary API through Offline Objects is supported for Android and iOS platforms. For Web platforms, you can use the getBinaryContent API for downloading content from the relational database adapter. If required, this API must maintain relations with offline records in the application logic.  
