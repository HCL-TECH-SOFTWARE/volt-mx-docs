...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>unpackNodeModules= < list of unpack node dependencies ></td>
    <td>Optional. Comma separated list of Node.js dependencies (with versions) that need to be unpacked.</td>
  </tr>
    <tr>
    <td>unpackBinaries= < list of unpack  binaries ></td>
    <td>Optional. Comma separated list of binary files or folders (e.g., .dll, .so) to be included during packaging.</td>
  </tr>
</table>
</body>
</html>
...
* A `dependencies` section for standard Node.js modules.

* `An unpackResources.dependencies` section for native modules that must be unpacked.

* An `unpackResources.binaries` section for platform-specific files (e.g., `.dll, .so,` folders) that need to be included.
...
* <b>macOS</b>:
    ...
    * `<app-install-directory>/Contents/Resources/app.asar.unpacked/binaries/`
    * `<app-install-directory>/Contents/Resources/app.asar.unpacked/node_modules/`

* <b>Windows</b>:

    * `<app-install-directory>/resources/app.asar.unpacked/binaries/`
    * `<app-install-directory>/resources/app.asar.unpacked/node_modules/`

##### Development Environment

* <b>All Platforms</b>:

    * `<project-root>/unpackResources/binaries/`
    * `<project-root>/unpackResources/node_modules/`
...
<tr>
  ...
  <tr>
    <td>voltmx.io.FileSystem.getInstalledDirectoryPath()</td>
    <td>Returns the path to the directory where the application executable is installed. Throws an exception on failure.</td>
  </tr>
  <tr>
...
* Make sure that you have installed Node.js version 20.11.1 or higher. You can download it from the [here](https://nodejs.org/en).
* Git is required for version control. Install it from [here](https://git-scm.com/).
* <b>Wix Toolset</b><br>
    To build and package a Windows application, you must install <b>Wix Toolset</b> in your Windows environment.
    <ol type="a"><li><b>Obtaining Wix Toolset</b>:
    <ul><li>Fetch the wix311.exe installer from the <a href="https://github.com/wixtoolset/wix3/releases/tag/wix3112rtm">GitHub release page</a>.</li></ul>
    <li><b>Installation Steps</b>:
    <ul><li>Run the wix311.exe installer.</li>
    <li>A prompt will appear indicating that the <b>WiX Toolset</b> requires the .NET Framework 3.5.1 Windows feature to be enabled.</li></ul>
    <li><b>Enabling .NET Framework 3.5.1 Windows Feature</b>:
    <ul><li>Navigate to <b>Start > Control Panel > Programs > Programs and Features</b>.</li>
    <li>Select <b>Turn Windows features on or off</b>.</li>
    <li>If it is not installed, enable <b>Microsoft .NET Framework 3.5</b> and click <b>OK</b> to confirm.</li>
    <li>You may encounter a message stating, "Windows needs files from Windows Update to finish installing some features." Click <b>Let Windows Update download the files for you</b>.</li></ul>
    <li><b>Completing WiX Toolset Installation</b>:
    <ul><li>Run wix311.exe once again.</li>
    <li>Click the <b>Install</b> button.</li>
    <li>A confirmation dialog, "Allow installer to make changes to your computer," will appear. Select <b>Yes</b> to proceed.</li></ul>
    <li><b>Finalizing Installation</b>:
    <ul>Once the installation process is complete, exit the WiX installer.</li>
    <li>Locate the "candle.exe" executable (usually at C:\Program Files (x86)\WiX Toolset v3.11\bin) and add this location to your Path environment variable.</li></ul>
    <li><b>Putting It All Together</b>:
    <ul><li>To ensure the changes take effect, restart Volt Iris from a new command prompt that recognizes the updated path.</li></ul></li></ol>          
