...
*   **navigateAndZoom** \[Boolean\] \[Optional\]: Decides whether the navigation to first pin should take place. It is available on Android and iOS. The default value of this parameter is true.  
...
*   orientation\[JSNumber\] - Mandatory. Specifies the direction at which the camera is pointing, in degrees clockwise from north. For iOS, this is available from iOS 7 onwards. 
*   northeast \[JSObject\] - Specifies the latitude and longitude keys and associated values. 
    
*   southwest \[JSObject\] - Specifies the latitude and longitude keys and associated values. 
*   latspan \[number\] - Specifies the spanning latitude in degrees. 
*   lonspan \[number\] - Specifies the spanning longitude in degrees. 
