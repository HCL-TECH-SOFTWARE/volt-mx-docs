...
*   This property is available on Desktop
...
*   constants.TEXTAREA\_KEY\_BOARD\_STYLE\_PHONE\_PAD: Specifies the keyboard to enter phone numbers.
...
For SPA, DesktopWeb and DesktopNative, constants.TEXTAREA_INPUT_MODE_NUMERIC is not available. By default it will be taken as constants.TEXTAREA_INPUT_MODE_ANY
...
The default value for TextArea is Constants.WRITING_TOOLS_BEHAVIOR_DEFAULT.
...
```
//At the time of creation of textArea widget

var ta1 = new voltmx.ui.TextArea2({
"autoCapitalize": constants.TEXTAREA_AUTO_CAPITALIZE_NONE, 
"focusSkin": "defTextArea Focus",
"height": "355dp",
"id": "tal",
"isVisible": true,
...
"showCloseButton": true,
"showProgress Indicator": false,
"placeholderSkin": "defTextAreaPlaceholder",
"writingTools Behavior": constants.WRITING TOOLS_BEHAVIOR_COMPLETE;
});

//For textArea widget at run time

Form1.textarea1.writingToolsBehavior = constants.WRITING_TOOLS_BEHAVIOR_COMPLETE;
```
