...
When you call the [voltmx.types](../../../Iris/iris_api_dev_guide/content/voltmx.types.rawbytes_namespace.md) API on the created voltmx.ui.NativeContainer object in JS layer, there are two possibilities:
