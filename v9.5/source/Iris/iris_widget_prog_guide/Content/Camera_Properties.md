...
The default value for the property is constants.CAMERA\_ACCESS\_MODE\_PUBLIC.
...
*   constants.CAMERA\_ACCESS\_MODE\_PRIVATE: The captured image or video is stored on the device and is not accessible to any other application on the device.
