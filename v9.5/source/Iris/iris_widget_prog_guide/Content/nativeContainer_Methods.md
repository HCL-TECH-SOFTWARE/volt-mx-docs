...
NativeContainer Methods
=======================

The NativeContainer has the following method associated with it:
...
<details close markdown="block"><summary>getContainerView Method</summary>

* * *

The method returns the NativeContainer layout view.
...
This method returns a valid view/layout when queried between onCreated and onCleanup callbacks - that is, after view hierarchy is being created and before the hierarchy is destroyed. Otherwise, the method will return null.

### Example

```

var layoutnative = frmNativeContainer.ntvCont.getContainerView();
alert(layoutnative);
...
*   iOS, Android, SPA, Desktop Web and Desktop Native
...
*   Available on all platforms except Desktop Web, Android and Desktop Native
