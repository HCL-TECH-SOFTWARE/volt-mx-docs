...
*   For Android, haptic feedback is performed only when users click on the element or at the end of scrolling the element.
...
```
/*Sample code to set the height property for a PickerView widget by using DP, Percentage and Pixels.*/
