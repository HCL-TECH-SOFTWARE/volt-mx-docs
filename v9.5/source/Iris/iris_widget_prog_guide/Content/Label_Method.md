...
Label widget is associated with the following method:
...
An `animation` object created using [voltmx.ui.createAnimation](../../../Iris/iris_api_dev_guide/content/voltmx.ui_functions.md#createAn?TocPath=References_voltmx.ui_Namespace_Functions______5) function.
