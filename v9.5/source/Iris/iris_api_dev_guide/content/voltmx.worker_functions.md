...
Available for iOS, Android, SPA, Desktop Native and Desktop Web. For more information, see [Scope](worker_apis.md#scope).
...
Available for iOS, Android, SPA, Desktop Native and Desktop Web.
