...
| LONGPRESS | pressDuration \[Number\] - specifies the minimum time interval (in seconds) after which the gesture is recognized. The default value is 1.{pressDuration:1} |
...
Available on all platforms except Server Side Mobile Web, Desktop Web and Desktop Native.
