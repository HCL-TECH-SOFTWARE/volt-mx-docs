...
### Platform Availability
    ...
    Available on all platforms except Desktop Web and Server Side Mobile Web and Desktop Native.
...
Available on all platforms except Desktop Web and Server Side Mobile Web and Desktop Native. On SPA, reading base64 from an image src is not supported, but you can read the base64 from an image which is displayed through base64.
...
*   Desktop Web (Google Chrome (v72 and later),Mozilla FireFox (v66), Opera (v60), Microsoft Edge, Safari) and Desktop Native.
