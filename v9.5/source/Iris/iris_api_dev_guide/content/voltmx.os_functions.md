...
Available on all platforms \*Dummy implementation on Server Side Mobile Web, SPA, and DesktopWeb and returns a dummy value.
...
Available on iPhone, iPad, Android, and Desktop Web
...
Applicable only on iPhone, Android, platforms.
