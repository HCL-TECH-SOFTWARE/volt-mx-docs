...
*   **screenWidth**: Specifies the screen width of the device by considering the device orientation at the time of query. The returned value is in device independent pixels (Dp). This attribute is supported in iOS, Android and SPA platforms.
*   **screenHeight**: Specifies the screen height of the device by considering the device orientation at the time of query. The returned value is in device independent pixels (Dp). This attribute is supported in iOS, Android and SPA platforms.
...
*   **name**: Specifies the name of the platform as iPhone, iPad, thin client (The name thin client is used for SPA/ Desktop Web / Mobile Web), and Android.
