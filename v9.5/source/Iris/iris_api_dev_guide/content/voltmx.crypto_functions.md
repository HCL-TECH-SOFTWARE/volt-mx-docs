...
> **_Note:_** From V9 SP2 onwards, the readKey data for a Volt MX App child app is stored in child app data and not under the parent app. This feature is applicable for iOS,and Android platforms.
...
| Parameters | Description |
| --- | --- |
| algo \[String\] - Mandatory | The algorithm used for the public key. Possible values are: RSA AES |
...
Available on all platforms except Service Side Mobile Web, Desktop Web, and SPA.
...
> **_Note:_** From V9 SP2 onwards, the saveKey data for a Volt MX App child app is stored in child app data and not under the parent app. This feature is applicable for iOS and Android platforms.
