...
*   The Public Key Pinning feature is applicable to `voltmx.net` APIs and the `voltmx.ui.Browser` widget on iOS. It is not applicable to the `voltmx.ui.Browser` widget on other platforms.
