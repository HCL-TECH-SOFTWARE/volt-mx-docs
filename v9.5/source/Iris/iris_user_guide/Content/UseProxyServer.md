...
The URLs have been categorized according to the respective cloud environments.

#### Volt Foundry Production Cloud

- https://api.hclvoltmx.com <br> Required for Volt Foundry authentication.
- https://manage.hclvoltmx.com <br> Required to log into and connect with the HCL Software Managed Volt Foundry Instance (Production Cloud).
- https://accounts.auth.hclvoltmx.com <br> URL to fetch the user's account details after logging in with Volt MX credentials.
- https://visualization.hclvoltmx.com <br> Required to fetch the Volt Iris update list and details.
- https://download.hclvoltmx.com <br> Required for fetching updates and plugins for Volt Iris.
- https://opensource.hcltechsw.com <br> Used for fetching and displaying release notes.
- https://hcl-tech-software.github.io <br> Connects helper text with Volt MX Product Documentation.
- https://community.hclvoltmx.com <br> Used for HCL Volt MX Marketplace integration.
- https://hclvoltmx-prototypetransit.s3.amazonaws.com <br> Used for publishing live previews to the HCL Software Managed Volt Foundry Production Cloud.
- https://iq.hclvoltmx.net <br> Used to connect to Volt IQ Chat Agent.

#### Volt Foundry Trial Cloud

- https://api.demo-hclvoltmx.com <br> Required for Volt Foundry authentication.
- https://manage.demo-hclvoltmx.com <br> Required to log into and connect with the Volt Foundry Trial Instance.
- https://accounts.auth.demo-hclvoltmx.com <br> URL to fetch the user's account details after logging in with Volt MX credentials.
- https://visualization.demo-hclvoltmx.com <br> Required to fetch the Volt Iris update list and details.
- https://download.demo-hclvoltmx.com <br> Required for fetching updates and plugins for Volt Iris.
- https://opensource.hcltechsw.com <br> Used for fetching and displaying release notes.
- https://hcl-tech-software.github.io <br> Connects helper text with Volt MX Product Documentation.
- https://community.demo-hclvoltmx.com <br> Used for HCL Volt MX Marketplace integration.
- https://hclvoltmx-prototypetransit-demo.s3.amazonaws.com <br> Used for publishing live previews to Volt Foundry Trial Cloud.
- https://iq.demo-hclvoltmx.net <br> Used to connect to Volt IQ Chat Agent.

#### Volt Foundry On-prem Deployment

- https://visualization.hclvoltmx.com <br> Required to fetch the Volt Iris update list and details.
- https://download.hclvoltmx.com <br> Required for fetching updates and plugins for Volt Iris.
- https://opensource.hcltechsw.com <br> Used for fetching and displaying release notes.
- https://hcl-tech-software.github.io <br> Connects helper text with Volt MX Product Documentation.
- https://community.hclvoltmx.com <br> Used for launching the HCL Volt MX Marketplace in an external (native) browser.
- https://iq.hclvoltmx.net <br> Used to connect to Volt IQ Chat Agent.

> **_Note:_** Ensure connectivity to your on-prem Foundry deployment endpoints that handle authentication and account management requirements.