...
> **_Note:_** Invoking a preprocessor or a postprocessor within any type of service is optional, depending on the needs of your application.<br>As part of offline Objects, while using  Delta Sync, $filter param  shouldn't be used in the Preproccesor as the $filter param holds the delta value as well the filter value defined at client App.  Updating filter in Preprocessor will overrride input filters from client App.
