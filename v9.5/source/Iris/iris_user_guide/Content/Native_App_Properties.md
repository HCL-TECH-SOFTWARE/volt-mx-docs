...
To ensure a successful Cordova build, the **gradleHome** property must be set in the androidbuild.properties file. This property should point to the gradle location. This property is mandatory for successful Cordova builds. If it is not set, an error will be thrown before building the Cordova module. 

`gradleHome = <gradle installed location>`

**Example**
`gradleHome = /Library/Gradle-XXX`
