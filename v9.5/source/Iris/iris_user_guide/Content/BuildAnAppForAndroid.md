...
>**Note:** From 9.5.47 onwards<br><li> JDK 17 is mandatory to build the Android application since the 9.5.47 release.</li><li>Iris needs JDK 17 to build the Android applications, hence the JDK 17 path must be given from build settings in Iris</li>
