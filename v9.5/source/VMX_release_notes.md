...
- [V9 Servicepack 5 Fixpack 57](#v9-servicepack-5-fixpack-57)
- [V9 Servicepack 5 Fixpack 56](#v9-servicepack-5-fixpack-56)
- [V9 Servicepack 5 Fixpack 55](#v9-servicepack-5-fixpack-55)
- [V9 Servicepack 5 Fixpack 54](#v9-servicepack-5-fixpack-54)
- [V9 Servicepack 5 Fixpack 53](#v9-servicepack-5-fixpack-54)
- [V9 Servicepack 5 Fixpack 52](#v9-servicepack-5-fixpack-52)
- [V9 Servicepack 5 Fixpack 51](#v9-servicepack-5-fixpack-51)
- [V9 Servicepack 5 Fixpack 50](#v9-servicepack-5-fixpack-50)
...
- [Earlier Iris releases](https://help.hcl-software.com/voltmx/v9.2/VMX_release_notes.html#volt-iris)

[Volt Foundry](#volt-foundry)

- [V9 Servicepack 5 Fixpack 21 Hotfix 4](#v9-servicepack-5-fixpack-21-hotfix-4)
- [V9 Servicepack 5 Fixpack 21 Hotfix 3](#v9-servicepack-5-fixpack-21-hotfix-3)
- [V9 Servicepack 5 Fixpack 21 Hotfix 2](#v9-servicepack-5-fixpack-21-hotfix-2)
- [V9 Servicepack 5 Fixpack 21 Hotfix 1](#v9-servicepack-5-fixpack-21-hotfix-1)
- [V9 Servicepack 5 Fixpack 21 Hotfix 0](#v9-servicepack-5-fixpack-21-hotfix-0)
- [V9 Servicepack 5 Fixpack 20 Hotfix 0](#v9-servicepack-5-fixpack-20-hotfix-0)
- [V9 Servicepack 5 Fixpack 18 Hotfix 2](#v9-servicepack-5-fixpack-18-hotfix-2)
- [V9 Servicepack 5 Fixpack 18 Hotfix 1](#v9-servicepack-5-fixpack-18-hotfix-1)
- [V9 Servicepack 5 Fixpack 18 Hotfix 0](#v9-servicepack-5-fixpack-18-hotfix-0)
- [V9 Servicepack 5 Fixpack 17 Hotfix 5](#v9-servicepack-5-fixpack-17-hotfix-5)
...
- [Earlier Foundry releases](https://help.hcl-software.com/voltmx/v9.2/VMX_release_notes.html#volt-foundry)

## Volt Iris

### V9 Servicepack 5 Fixpack 57
September 17, 2025
...
### V9 Servicepack 5 Fixpack 56
August 08, 2025

* Updated internal libraries to comply with Android Play Store guidelines on 16 KB pagefile size. See details [here](https://developer.ds.hcl-software.com/t/framework-update-16kb-page-size-support/171697).

* Updated support to include C# DLLs for Desktop Native NFIs (Windows) via ASAR. 

For detailed information about fixes and known issues in this release, see the <a href="https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0101445" target="_blank">Cumulative fix list for HCL Volt MX</a>.


### V9 Servicepack 5 Fixpack 55
July 07, 2025

* Added support for Application Callbacks API for Desktop Native platform.

* Implemented window (re)size constraints for Desktop Native platform.

* Added support for custom certificates for Browser widget on Android platform.

* Enhanced text length validation for text widgets.

* Added support for scene-based lifecycle in iOS apps.

For detailed information about fixes and known issues in this release, see the <a href="https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0101445" target="_blank">Cumulative fix list for HCL Volt MX</a>.


### V9 Servicepack 5 Fixpack 54
May 26, 2025
...
### V9 Servicepack 5 Fixpack 53
May 06, 2025

* Enhanced binary protection.

For detailed information about fixes and known issues in this release, see the <a href="https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0101445" target="_blank">Cumulative fix list for HCL Volt MX</a>.


### V9 Servicepack 5 Fixpack 52
April 14, 2025

* Extended framework support to newer iOS devices.

For detailed information about fixes and known issues in this release, see the <a href="https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0101445" target="_blank">Cumulative fix list for HCL Volt MX</a>.


### V9 Servicepack 5 Fixpack 51
March 17, 2025
...
### V9 Servicepack 5 Fixpack 50
February 12, 2025

* Updated the branding for HCL Volt MX Marketplace integrations to Volt Iris.
...
* Added MacOS Sequoia support for Iris.
* Added support for new icon themes in iOS 18.
* Updated UI to support icon configurations for new device family sets in iOS.
...
<details close markdown="block"><summary> Micro Apps Architecture </summary>
...
<details close markdown="block"><summary>Navigation Manager</summary>
...
<details close markdown="block"><summary>Configure Style Constants</summary>
...
<details close markdown="block"><summary>Component Updates</summary>
...
<details close markdown="block"><summary>iOS Enhancements</summary>
...
<details close markdown="block"><summary>Android Enhancements</summary>
...
<details close markdown="block"><summary>Responsive Web Enhancements</summary>
...
<details close markdown="block"><summary>Test Automation Enhancements</summary>
...
<details close markdown="block"><summary>Data and Services Panel Enhancements</summary>
...
<details close markdown="block"><summary>Reference Architecture Extension Enhancements</summary>
...
<details close markdown="block"><summary>Specify the Build Format for Apps</summary>
...
<details close markdown="block"><summary>Support to access KSLint from the Help Menu</summary>
...
<details close markdown="block"><summary>Accessibility Enhancement</summary>
...
<details close markdown="block"><summary>Provide a pop-up Title for rooted devices</summary>
...
<details close markdown="block"><summary>Hot Reload Enhancements</summary>
...
<details close markdown="block"><summary>Integrate Volt MX Components in Angular Apps</summary>
...
### V9 Servicepack 5 Fixpack 21 Hotfix 4
August 15, 2025
...
### V9 Servicepack 5 Fixpack 21 Hotfix 3
June 09, 2025
...
### V9 Servicepack 5 Fixpack 21 Hotfix 2
May 26, 2025
...
### V9 Servicepack 5 Fixpack 21 Hotfix 1
May 12, 2025
...
### V9 Servicepack 5 Fixpack 21 Hotfix 0
April 14, 2025

* Updated supported version for Docker containers to 28.0.4.
* Enhanced error landing pages to relay more information to Volt Foundry users.

For detailed information about fixes and known issues in this release, see the <a href="https://support.hcltechsw.com/csm?id=kb_article&sysparm_article=KB0101445" target="_blank">Cumulative fix list for HCL Volt MX</a>.


### V9 Servicepack 5 Fixpack 20 Hotfix 0

#### (With AppFactory)

March 31, 2025

* With 9.5.20.0 release, Volt MX distribution, licensing, and usage monitoring moved to the My HCLSoftware (MHS) portal.

    * For a limited time, installers and other downloadable assets remained available through FNO. From July '25, all downloadable assets will be available only through MHS.

    * License activation and usage monitoring for versions 9.5.20 and higher will be handled solely through MHS.  For more information refer [here](https://help.hcl-software.com/voltmx/v9.5/Foundry/voltmx_licensing_guide/Content/Volt_Foundry_Licensing_Guide.html)

* Updated Tomcat AppServer version.

* Removed support for Legacy (deprecated) FCM API.
...
### V9 Servicepack 5 Fixpack 18 Hotfix 2
March 10, 2025
...
### V9 Servicepack 5 Fixpack 18 Hotfix 1
February 24, 2025
...
### V9 Servicepack 5 Fixpack 18 Hotfix 0
February 17, 2025
...
### V9 Servicepack 5 Fixpack 17 Hotfix 5
January 20, 2025
...
<details close markdown="block"><summary>Foundry Identity</summary>
...
<details close markdown="block"><summary>Foundry Integration Server</summary>
...
* **Enhancements to the JavaScript SDK**
   ...
   * Added support to login to an OAuth 2.0 provider in the same
     browser window.
   * Added support to use Server Event APIs. These APIs can be
     used to establish a connection between a client app and a WebSocket on Volt MX Foundry. 
...
* **Updates to Server Events APIs**
     ...
     *  Added the setupServerEvents API, which can be used to
       establish a connection between a client app and a WebSocket on Volt MX Foundry.

     *  Moved the global callbacks, such as onEventCallback
        (onMessageCallback), onErrorCallback, and onCloseCallback, to the setupServerEvents API.  
...
<details close markdown="block"><summary>Added SSL Pinning support for native channels</summary>

SSL Pinning is supported for the Android and iOS channels, which can be used to connect to WebSockets on Volt MX Foundry. 

</details>

<details close markdown="block"><summary>Added support for authentication into Foundry by using Azure-SAML</summary>

Support for external authentication by using Azure-SAML has been added to Volt MX Foundry. 

</details>

<details close markdown="block"><summary>Added support to enable secure connections for caching</summary>

Support to enable an SSL connection between the Authentication Service and Redis caching service to cache configuration. 

</details>

<details close markdown="block"><summary>MFCLI</summary>
...
<details close markdown="block"><summary>HCL Volt MX App Factory</summary>
...
<details close markdown="block"><summary>Volt MX Foundry on Red Hat OpenShift </summary>
...
<details close markdown="block"><summary>Cloud Installer on MS Azure</summary>

*  Added support to use multiple nodepools in a single cluster on Azure
...
<details close markdown="block"><summary>Volt MX Foundry Containers</summary>
