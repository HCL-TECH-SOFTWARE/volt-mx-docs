...
> **_Note:_** The Volt MX EAS (Enterprise App Store) Service is enabled by default for all Volt MX AppPlatform users. Upon publishing a native client application, the Volt MX App Store (Enterprise App Store) will become accessible in the Foundry Console under the "Apps" view.
