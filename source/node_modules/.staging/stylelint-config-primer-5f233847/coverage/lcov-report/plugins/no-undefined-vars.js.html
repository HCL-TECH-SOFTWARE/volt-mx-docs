...
<html lang="en">
<head>
    <title>Code coverage report for plugins/no-undefined-vars.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">plugins</a> no-undefined-vars.js
    </h1>
    <div class='clearfix'>
...
<a name='L80'></a><a href='#L80'>80</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
module.exports = stylelint.createPlugin(ruleName, (enabled, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
...
&nbsp;
  const {files = <span class="branch-0 cbranch-no" title="branch not covered" >['**/*.scss', '!node_modules'],</span> verbose = false} = options
  // eslint-disable-next-line no-console
  const log = verbose ? <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >(.</span>..args) =&gt; <span class="cstat-no" title="statement not covered" >console.warn(...args) </span></span>: noop
...
&nbsp;
  return (root, result) =&gt; {
    root.walkRules(rule =&gt; {
      rule.walkDecls(decl =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (seen.has(decl)) {
