...
<html lang="en">
<head>
    <title>Code coverage report for plugins/lib/variable-rules.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">plugins/lib</a> variable-rules.js
    </h1>
    <div class='clearfix'>
...
<a name='L98'></a><a href='#L98'>98</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">8x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const stylelint = require('stylelint')
...
<span class="cstat-no" title="statement not covered" >    console.warn(`Unable to get variables.json from @primer/css. Replacements will need to be specified manually.`)</span>
  }
&nbsp;
