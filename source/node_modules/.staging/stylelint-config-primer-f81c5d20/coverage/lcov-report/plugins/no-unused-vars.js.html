...
<html lang="en">
<head>
    <title>Code coverage report for plugins/no-unused-vars.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">plugins</a> no-unused-vars.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const TapMap = require('tap-map')
...
function stripCwd(path) {
  return path.startsWith(cwd) ? path.substr(cwd.length + 1) : <span class="branch-1 cbranch-no" title="branch not covered" >path</span>
}
&nbsp;
