...
For instance, if you design a form with two TextBox widgets, and one Button widget, Volt MX IQ predicts that you could be creating a Login form and recommends designs such as the [Login](https://marketplace.kony.com/items/login-advanced?search=login) component from [HCL Forge](https://marketplace.kony.com/) .
