...
Corresponding to item number 5 in the [diagram](#Image), this pane displays the properties for a number of aspect of your application, divided into five tabs:
...
Corresponding to item number 6 in the [diagram](#Image), the Data & Services panel enables you to link back-end data services to your application's user interface elements seamlessly with low-code to no-code.
...
Corresponding to item number 8 in the [diagram](#Image), the Account Information area displays a and connected devices icon, Notes button, download icon, your Volt MX Cloud account, your Volt MX account user name.
...
[](#DefPerspImage)[Return to the diagram](#Image)

Library Explorer
----------------

Corresponding to item number 7 in the [diagram](#Image), the Library Explorer consists of three panes: Default Library, My Libraries, and Search bar.
...
Corresponding to item number 9 in the [diagram](#Image), the lower pane consists of the four tabs: Console, Search, Build and Debug.
