...
*   Here is a cross-reference link: See [Image Positioned Left](ImagePositionedLeft.html).
*   Here is a cross-reference link: See [Image Positioned Right](ImagePositionedRight.html).
