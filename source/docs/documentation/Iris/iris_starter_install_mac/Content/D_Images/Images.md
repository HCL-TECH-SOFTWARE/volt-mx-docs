...
Here is a small image inline ![](../Resources/Images/SaveButton.png).

*   Here is a cross-reference link: See [Thumbnail Image](ThumbnailImage.html).
*   Here is a cross-reference link: See [Positioned Images](Positioned Images.html).
*   Here is a cross-reference link: See [Image Within List](ImageWithinList.html).
