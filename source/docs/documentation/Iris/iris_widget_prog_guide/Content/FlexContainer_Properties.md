...
For more information about the Simple Responsive design, click [here]({{ site.baseurl }}/docs/documentation/Iris/iris_user_guide/Content/Responsive_Design.html).
