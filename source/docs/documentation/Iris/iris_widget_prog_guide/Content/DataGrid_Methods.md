...
Specifies the JSObject that represents the row data as key value pairs. The format of the array of data is explained in [data](DataGrid_Properties.html#data) property of DataGrid basic properties.
...
{% highlight voltMx %}//Sample code to invoke addAll method by using a DataGrid widget.
...
{% highlight voltMx %}/*Sample code to invoke addDataAt method by using a DataGrid widget to append the data in the second index position.*/  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[applyCellSkin Method](javascript:void(0);)
...
The skin set in this property takes precedence over the skin set using [rowNormalSkin](DataGrid_Properties.html#rowNormalSkin).

Example

{% highlight voltMx %}//Sample code to invoke applyCellSkin method by using a DataGrid Widget.  
...
{% highlight voltMx %}//Sample code to invoke removeAll method by using a DataGrid Widget.  
...
{% highlight voltMx %}//Sample code to invoke removeAt method to delete the second row of a DataGrid Widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[selectAllRows Method](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to invoke selectAllRows method for a DataGrid Widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[setCellDataAt Method](javascript:void(0);)
...
{% highlight voltMx %}/*Sample code to invoke setCellDataAt method to set data inside a cell of index [1,2] of a DataGrid widget.*/  
...
{% highlight voltMx %}//Sample code to invoke setData method by using a DataGrid widget.  
...
{% highlight voltMx %}//Sample code to invoke setDataAt method by using a DataGrid widget.  
...
{% highlight voltMx %}function onPeekCallback(
    widget,
    contextInfo
) {
    var previewInfoTable = {
...
{% highlight voltMx %}function onPopCallback(
    widget,
    peekForm
) {
    // preview form used for pop also
