...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[addTab Method](javascript:void(0);)
...
{% highlight voltMx %}/*Sample code to invoke addTab method by using a TabPane widget where the app.png image is available in the resources folder.*/
...
{% highlight voltMx %}var imgObjRef = voltmx.image.createImage("local.png");
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[addTabAt Method](javascript:void(0);)
...
{% highlight voltMx %}/*Sample code to invoke addTabAt method by using a TabPane widget where the TabImage.png image is available in the resources folder.*/
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[removeTabAt Method](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to invoke removeTabAt method by using a TabPane widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[removeTabByld Method](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to invoke removeTabById method by using a TabPane widget.  
