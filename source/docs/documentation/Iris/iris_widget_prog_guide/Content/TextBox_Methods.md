...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[getSelection Method](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to invoke the getSelection method of a TextBox widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[setSelection Method](javascript:void(0);)
...
*   when the secureTextEntry property is set to true in the Windows platform.
...
In the Windows platform, the setSelection and getSelection methods are not supported when the secureTextEntry property is set to true.
...
{% highlight voltMx %}//Sample code to invoke the setSelection method of a TextBox widget.
