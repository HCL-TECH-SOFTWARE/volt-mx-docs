...
{% highlight voltMx %}//Using base64 property in a form frmBase64.
function readb() {
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[cacheConfig Property](javascript:void(0);)
...
{% highlight voltMx %} //Sample code to set the cacheConfig property in the Image widget
...
{% highlight voltMx %}//Sample code to set the clipView property in an Image widget.  
...
{% highlight voltMx %}//Sample code to set the containerWeight property of an Image widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[glossyEffect Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the glossyEffect property of an Image widget.  
...
{% highlight voltMx %}/*Sample code to set the height property for an Image widget by using DP, Percentage and Pixels.*/
...
{% highlight voltMx %}//Sample code to set the hoverSkin property for an Image widget.
...
{% highlight voltMx %}//Defining properties for an Image with the ID :"imageIdTest".
var basicConfImage = {
    id: "imageIdTest",
    isVisible: true,
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[imageScaleMode Property](javascript:void(0);)
...
{% highlight voltMx %} //Sample code to set the imageScaleMode property for an Image widget.  
...
{% highlight voltMx %}//Sample code to set the imageWhenFailed property of an Image widget to a local resource.   
...
{% highlight voltMx %}//Sample code to set the imageWhenFailed property of an Image widget to an Image Object.   
...
{% highlight voltMx %}//Sample code to set the imageWhileDownloading property of an Image widget to a local resource.   
...
{% highlight voltMx %}//Sample code to set the imageWhileDownloading property of an Image widget to an Image Object.   
var imgObjRef = voltmx.image.createImage("local.png");  
...
{% highlight voltMx %}//Sample code to set info property for an Image widget.
...
{% highlight voltMx %}//Sample code to set the isVisible property of an Image widget.  
...
{% highlight voltMx %} //Sample code to set the padding property of an Image widget.  
...
{% highlight voltMx %}//Sample code to set the rawBytes property as "11111" for an Image widget.   
...
{% highlight voltMx %}//Sample code to set the rawBytes property using an Image Object.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[referenceHeight Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the referenceHeight property of an Image widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[referenceWidth Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the referenceWidth property of an Image widget.  
...
{% highlight voltMx %}//Sample code to set the renderAsAnchor property of an Image widget.  
...
{% highlight voltMx %}//Sample code to set the shadowDepth property of an Image widget.  
...
{% highlight voltMx %}//Sample code to set the shadowType property of an Image widget.  
...
{% highlight voltMx %}//Sample code to set the skin property of an Image widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[src Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the src property of an Image widget to a URL.  
...
{% highlight voltMx %}//Sample code to set the src property of an Image widget to an Image Object.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[tintConfig Property](javascript:void(0);) 
...
| mode | A value from the Tint Mode Constants specified in the [constants namespace]({{ site.baseurl }}/docs/documentation/Iris/iris_api_dev_guide/content/constants_namespace.html) that controls how the tint color is added to the widget. These constants are different for Android and iOS. See the Constants documentation for more information. |
...
{% highlight voltMx %}//Sample code to set the tintConfig property of an Image widget.
...
{% highlight voltMx %}//Sample code to set the toolTip property of an Image widget.
...
{% highlight voltMx %} //Sample code to set the widgetAlignment property of an Image widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[zoomEnabled Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to enable zoom in an Image widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[zoomValue Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the value of zoom to an Image widget.  
