...
The properties for the MenuItem widget are:
...
/*This will not update the widget info 
...
//Reading the info of the MenuItem.		
...
Specifies the type of the MenuItem as _ok_, _back_, or _exit_.
