...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[getContainerView Method](javascript:void(0);)
...
{% highlight voltMx %}var layoutnative = frmNativeContainer.ntvCont.getContainerView();
alert(layoutnative);
