...
{% highlight VoltMx %}//Defining the properties for an MLCamera widget with id:"myMLCamera".
var camBasic = {
    id: "myMLCamera",
    skin: "camSkin",
    focusSkin: "camFSkin",
...
{% highlight VoltMx %}//Sample code to set info property for an MLCamera widget
