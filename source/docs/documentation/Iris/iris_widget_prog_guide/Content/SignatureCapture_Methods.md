...
{% highlight VoltMx %}//Sample code to invoke the clear method by using a SignatureCapture widget.

frmSCapture.mySCapture.clear();
{% endhighlight %}
...
<details close markdown="block"><summary>save Method</summary>
...
{% highlight VoltMx %}//Sample code to invoke the save method by using a SignatureCapture widget.

frmSCapture.mySCapture.save();
{% endhighlight %}
