...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[appendsHTTPForHyperLinks Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to enable the appendsHTTPForHyperLinks property for a RichText widget.
...
{% highlight voltMx %}//Sample code to set the breakStrategy property for a RichText widget.
...
{% highlight voltMx %}//Sample code to set the clipView property of a RichText widget.
...
{% highlight voltMx %}/*Sample code to set the height property for a RichText widget by using DP, Percentage and Pixels.*/
...
{% highlight voltMx %}//Sample code to set the hoverSkin property of a RichText widget.  
...
{% highlight voltMx %}//Sample code to set the hyphenationFrequency property for a RichText widget.
...
{% highlight voltMx %}//Defining properties for a RichText with id:"rText"
var rTextBasic = {
    id: "rText",
    skin: "rTextSkin",
    linkSkin: "lnkSkin",
...
{% highlight voltMx %}//Sample code to set the info property of a RichText widget.
...
This property is not applicable if the widget is placed in a [Segment](Segment.html). When the widget is placed in a Segment, the _Visibility_ of the widget is controlled by the [data](Segment_Properties.html#data) property of the segment.

Example

{% highlight voltMx %}//Sample code to set the isVisible property of a RichText widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[linkFocusSkin Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the linkFocusSkin property of a RichText widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[linkSkin Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the linkSkin property of a RichText widget.
...
{% highlight voltMx %}//Sample code to set the shadowDepth property of a RicheText widget.   
...
{% highlight voltMx %}//Sample code to set the shadowType property of a RichText widget.   
...
{% highlight voltMx %}//Sample code to set the skin property of a RichText widget.   
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[superScriptSkin Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the superScriptSkin property of a RichText widget.   
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[telephoneLinkSkin Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the telephoneLinkSkin property of a RichText widget.   
...
{% highlight voltMx %}//Sample code to set the text property of a RichText widget.   
...
{% highlight voltMx %}//Sample code to set the toolTip property of a RichText widget.   
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[wrapping Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the wrapping property of a RichText widget.   
