...
{% highlight voltMx %}//Sample code to set the accessMode property of a SignatureCapture widget.
...
{% highlight voltMx %}/*Sample code to set the height property for a SignatureCapture widget by using DP, Percentage and Pixels.*/
...
{% highlight voltMx %}//Defining the properties for SignatureCapture with the ID :"signature"
var signatureBasic = {
    id: "signature",
    info: {
        key: "signature"
...
{% highlight voltMx %}//Sample code to set the info property of a SignatureCapture widget.
...
{% highlight voltMx %}//Sample code to set the isVisible property of a SignatureCapture widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[penWidth Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the penWidth property of a SignatureCapture widget.
...
{% highlight voltMx %}//Reading rawBytes of SignatureCapture
...
{% highlight voltMx %}//Sample code to set the skin property of a SignatureCapture widget.
