...
{% highlight VoltMx %}//Sample code to set the onSelection event callback to a RadioButtonGroup widget.
...
{% highlight VoltMx %}//Sample code to set the postOnclickJS event callback to a RadioButtonGroup widget.
...
{% highlight VoltMx %}//Sample code to set the preOnclickJS event callback to a RadioButtonGroup widget.
