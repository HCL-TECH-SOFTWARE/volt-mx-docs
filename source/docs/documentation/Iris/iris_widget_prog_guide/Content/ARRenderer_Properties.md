...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[activatesCoachingOverlayAutomatically Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code for defining activatesCoachingOverlayAutomatically property in arscene ARRenderer widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[canSaveExperienceCallback Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to add the canSaveExperienceCallback property for ARRenderer //widget
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[debugOptions Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the debugOptions property for arscene ARRenderer widget.  
var myscene = new voltmx.ui.ARRenderer({
    "placeholderText": "Please wait while the camera loads..",
    "placeholderSkin": "mpiSknlblItemName",
    "height": "100%",
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[enableCloudAnchors Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to add a key in the AndroidManifest.xml file.  
...
{% highlight voltMx %}/*Sample code to enable the enableCloudAnchor property using arscene ARRenderer widget.*/
...
{% highlight voltMx %}//Defining the properties for an ARRenderer widget with id:"myARRenderer".
var myscene = new voltmx.ui.ARRenderer({
 "placeholderText": "Please wait while the camera loads..",
 "placeholderSkin": "mpiSknlblItemName",
 "height": "100%",
...
{% highlight voltMx %}//Sample code to set info property for an ARRenderer widget.
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[overlay Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the overlay property for myARRenderer ARRenderer widget with flx1 FlexContainer.*/  
...
{% highlight voltMx %}//Sample code to set the arRenderSkin placeholderSkin property for myARRenderer ARRenderer widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[placeholderText Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to enable the placeholderText property for an ARRenderer widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[sceneConfig Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set the sceneConfig property for myARRenderer ARRenderer widget.  
