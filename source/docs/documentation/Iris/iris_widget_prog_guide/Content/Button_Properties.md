...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[buttonType Property](javascript:void(0);)
...
{% highlight voltMx %}var nativelight = new voltmx.ui.Button({
...
{% highlight voltMx %} //Sample code to set the cacheConfig property in the Button widget
...
{% highlight voltMx %}form1.Btn1.clipView = {
...
{% highlight voltMx %}//Sample code to enable enableHapticFeedback property in a Button widget.  
...
Specifies that the URL must be opened directly from the web site without having to contact the Volt MX FoundryServer.
...
{% highlight voltMx %}//Sample code to define the externalURL property for a Button widget.
...
{% highlight voltMx %}//Sample code to define the focusSkin property for a Button widget.
...
{% highlight voltMx %}//Defining the properties for a button with glowEffect:true.
var btnBasic = {
    id: "button1",
    isVisible: true,
    skin: "btnSkin",
...
{% highlight voltMx %}//Defining the properties for a button with id:"button1".
var btnBasic = {
    id: "button1",
    isVisible: true,
    skin: "btnSkin",
...
{% highlight voltMx %}//Sample code to set info property for a Button widget
...
> **_Note:_** This property is not applicable if the widget is placed in a [Segment](Segment.html). When the widget is placed in a Segment, the _Visibility_ of the widget is controlled by the [data](Segment_Properties.html#data) property of the segment.

Example

{% highlight voltMx %}//Sample code to set isVisible property for a Button widget
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[nativeButtonFocusImage Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to define the nativeButtonFocusImage property for a Button widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[nativeButtonNormalImage Property](javascript:void(0);)
...
{% highlight voltMx %}/*Sample code to define the nativeButtonNormalImage property for a Button widget.*/  
...
{% highlight voltMx %}//Sample code to define the pressedSkin property for a Button widget.
...
{% highlight voltMx %}//Sample code to define the rawBytes property of a Button widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[rippleBackground Property](javascript:void(0);)
...
{% highlight voltMx %}form1.Btn1.rippleBackground = {
...
{% highlight voltMx %}form1.Btn1.shadowDepth = 10;
{% endhighlight %}
...
{% highlight voltMx %}form1.Btn1.shadowType = constants.VIEW_BOUNDS_SHADOW;
{% endhighlight %}
...
{% highlight voltMx %}//Sample code to enable the showProgressIndicator property for a Button widget.  
...
Specifies the URL to which the current Form data should be submitted, without contacting Volt MX Foundry Server. This is typically required when the data collection is done using Volt MX Iris Form but is actually posted to a third-party site.
...
If set to _true,_ then the URL is submitted without contacting the Volt MX Foundry Server.

If set to _false,_ then the URL is submitted contacting the Volt MX Foundry Server.

For example, for an application that requires the user to provide confidential data, you can route the data directly to the server of the website without contacting the Volt MX Foundry Server using the [externalURL](#external) property. Doing so, opens the resultant site in the same window rather than opening it in a new window.

Example

{% highlight voltMx %}//Sample code to set the submitURL property for Button widget.
...
{% highlight voltMx %}//Sample code to set the text property for Button widget.
...
{% highlight voltMx %}//Sample code to set the toolTip property for Button widget.
