...
{% highlight voltMx %}//Sample code to enable the hidePreviousNextMonthDates property for a Calendar widget.  
...
{% highlight voltMx %}//Sample code to set skin Property for a Calendar widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[timeSheetSkin Property](javascript:void(0);)
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[titleOnPopup Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set titleOnPopup Property for Calendar widget.  
...
{% highlight voltMx %}//Sample code to set toolTip Property for Calendar widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[validEndDate Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set validEndDate Property for Calendar widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[validStartDate Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set validStartDate Property for Calendar widget.  
...
{% highlight voltMx %}//Sample code to configure viewConfig property in Desktop Web platform  
mygridConfig = {  
"gridConfig": {  
...
{% highlight voltMx %}//Defining the properties for Calendar with viewType as GRID_POPUP
var calBasicConf = {
    id: "calendar1",
    isVisible: true,
    dateComponents: [31, 12, 2012, 04, 30, 55],
...
{% highlight voltMx %}//Sample code to set wheelBackgroundColor Property for Calendar widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[widgetDataMapForCell Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to set widgetDataMapForCell property for Calendar widget.  
...
[![Closed](../Skins/Default/Stylesheets/Images/transparent.gif)](javascript:void(0);)[year Property](javascript:void(0);)
...
{% highlight voltMx %}//Sample code to read the year property of the date selected in a Calendar widget.  
