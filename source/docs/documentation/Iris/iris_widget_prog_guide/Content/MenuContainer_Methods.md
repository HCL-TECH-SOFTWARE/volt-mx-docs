...
Specifies an array to represent data as key value pairs. The format of the array of data is explained in [data](MenuContainer_Basic_Properties.html#data) property of menuContainer basic properties. The top most menu items are directly added to the menuContainer.
...
Specifies the JSObject to represent data as key value pairs. The format of the array of data is explained in [data](MenuContainer_Basic_Properties.html#data) property of MenuContainer basic properties.

Index \[Array\] - Mandatory

Specifies an array representing the index at which the menu item data needs to be added. The format of the array is explained in [selectedMenuIndex](MenuContainer_Basic_Properties.html#selected) property of MenuContainer basic properties. For example, \[0, 1, 2\] - Add data at 2nd position of 1st menu item under 0th menu item in the menu container.
...
Specifies an array representing the Index at which the menu item data needs to be removed. The format of the array is explained in [selectedMenuIndex](MenuContainer_Basic_Properties.html#selected) property of MenuContainer basic properties.
