...
2.  The following details are required for Flyway configuration:
    ...
    *   Placeholders for Admin:
    {% highlight voltMx %}# For Admin (admindb), replace the following placeholders in SQL migrations for your database flyway.placeholders.VOLTMX_SERVER_STORAGE_DATABASE_TYPE -> value must be 
        ...
        flyway.placeholders.VOLTMX_SERVER_JMS_USER_PASSWORD="" ([Encrypt](Encrypt_Passwords.html) this password) flyway.placeholders.VOLTMX_SERVER_KEYSTORE_LOCATION=""
