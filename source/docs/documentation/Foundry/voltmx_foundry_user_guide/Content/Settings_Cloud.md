...
| **Logic Services** - Access to the Integrate Node.js Services to Foundry Applications.<br><br> Refer to [How to Integrate Node.js Services into Foundry Apps](Logic_in_Apps.html). | ![](Resources/Images/tickN_25x25.jpg) | ![](Resources/Images/Tick-Mark-04_24x24.png) |
| **Logging Console** - Access to the logs for this environment from the Log Console.<br><br> Refer to [Log Services](Logging_as_a_Service.html). | ![](Resources/Images/tickN_25x25.jpg) | ![](Resources/Images/Tick-Mark-04_24x24.png) |
...
Only users with the Owner role in the account can access this tab. For more information on multi-factor authentication, refer to [How to Enable Multi-Factor Authentication](EnablingMultiFactorAuthentication.html).
