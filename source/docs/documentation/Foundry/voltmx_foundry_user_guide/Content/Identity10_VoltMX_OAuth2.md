...
6.  Under **User Attribute Selectors**, configure the following fields to extract the required information from the response:
    ...
    {% highlight voltMx %} // Sample profile response in JSON format  
    ...
    {% endhighlight %}{% highlight voltMx %} // Sample profile attributes selectors for the above response  
    ...
    "phone":"phone"
    "email":"email\[0\]" 
    {% endhighlight %}{% highlight voltMx %} // Sample custom attributes selectors for the above response  
