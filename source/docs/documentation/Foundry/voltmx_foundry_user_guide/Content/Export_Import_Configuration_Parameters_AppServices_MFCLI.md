...
{% highlight voltMx %}java -jar mfcli.jar import-config-properties -u abc@voltmx.com -p abc123 -au http://10.10.25.18:8080 -cu http://10.10.25.18:8081 -f "C:\\tmp\\Sample.zip" -e "TestEnv"
{% endhighlight %}
