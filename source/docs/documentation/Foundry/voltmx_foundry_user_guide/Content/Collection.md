...
User Guide: [Integration](Services.html#integration) \> [Advanced Configurations](Advanced_Configurations.html) > [Collection Support](#collection-support) > Collection Support in Request Input for SOAP
...
{% highlight voltMx %} <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:sap-com:document:sap:soap:functions:mc-style">
   <soapenv:Header/>
   <soapenv:Body>
...
{% highlight voltMx %} [{ "firstname": "Sam", "lastname": "Tim"  }, { "firstname": "Jim","lastname": "Jerry" }]
{% endhighlight %}
...
{% highlight voltMx %} #foreach $items
            <item>
				   <Bldat>$Bldat</Bldat>
				   <Budat>$Budat</Budat>
				   <Mtsnr>$Mtsnr</Mtsnr>
...
{% highlight voltMx %} [{"Bldat":"123","Budat":"adf","Mtsnr":"dsd"},{"Bldat":"234","Budat":"ffg","Mtsnr":"aff"},{"Bldat":"677","Budat":"fdf","Mtsnr":"jft"}]
{% endhighlight %}
