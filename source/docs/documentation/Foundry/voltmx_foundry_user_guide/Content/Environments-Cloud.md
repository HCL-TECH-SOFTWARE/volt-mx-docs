...
*   **Clouds**: Following consoles are available for each of the cloud account:
    ...
    *   **App Services**: For more information, refer [Appendix - App Services](Appendix_-_App_Services.html).
    *   **Log Services**: For more information, refer [Log Services](Logging_as_a_Service.html).
    *   **VoltMX Foundry Sync**: For more information, refer [VoltMX Foundry Sync]({{ site.baseurl }}/docs/documentation/Foundry/voltmx_sync_console_user_guide/Content/Homepage.html).
    *   **VoltMXFoundry Messaging**: For more information, refer [VoltMXFoundry Messaging]({{ site.baseurl }}/docs/documentation/Foundry/vms_console_user_guide/Content/Introduction_1.html).
    
    > **_Note:_** You can view all applications published to a Runtime Environment. [Refer Applications Published to a Runtime Environment](Published_Apps-Environments.html)
