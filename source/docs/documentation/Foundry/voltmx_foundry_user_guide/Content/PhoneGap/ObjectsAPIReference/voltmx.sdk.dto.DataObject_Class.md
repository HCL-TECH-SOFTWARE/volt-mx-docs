...
User Guide: [SDKs](../../Foundry_SDKs.html) > [Cordova (PhoneGap) SDK](../Installing_PhoneGap_SDK.html) > [Invoking an Object Service](Objects_API_Reference.html) > [Data Transfer Objects](Data_Transfer_Objects.html) > voltmx.sdk.dto.DataObject Class
