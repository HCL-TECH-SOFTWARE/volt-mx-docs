...
Let us assume both apps use the same identity service **[User Store](Identity12_VoltMXUR.html#Identity.html#UserRepository)** in their Volt MX Foundry backend.
