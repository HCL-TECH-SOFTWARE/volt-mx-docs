...
> **_Note:_**  
After you link the service to a Foundry app, you can use the service in the [Data Panel]({{ site.baseurl }}/docs/documentation/Iris/iris_user_guide/Content/DataPanel.html#top) of Volt MX Iris.
...
3.  Invoke a GET call to the [Profile endpoint](#profile-api) with the authorization header.  
    ...
    Curl example:  
    {% highlight voltMx %}Curl -X GET " https://100000012.auth.voltmxcloud.com/oidc/profile " -H "accept: application/json" -H "Authorization Bearer eyAidHl...H3mspKIPnAKzEbyc"
    {% endhighlight %}
...
{% highlight voltMx %}POST https://<<accountnumber>>.auth.voltmxcloud.com/oidc/authorize/<provider_name>?client_id=<appkey>&scope=<scopes>&response_type=code&redirect_uri=<valid redirect uri>&prompt=<value>
{% endhighlight %}
