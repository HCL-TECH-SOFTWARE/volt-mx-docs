...
> **_Note:_** For more hands-on approach on how to implement Engagement Services, import and preview the [Events app](https://marketplace.kony.com/items/events) using Volt MX Iris.
