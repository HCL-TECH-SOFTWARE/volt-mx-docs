...
For more details about how to define campaign messages, refer: [Defining Campaign Messages]({{ site.baseurl }}/docs/documentation/Foundry/vms_console_user_guide/Content/Campaigns/Adding_a_Campaign.html#Define)
