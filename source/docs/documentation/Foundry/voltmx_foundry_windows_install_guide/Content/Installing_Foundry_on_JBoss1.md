...
2.  In HTTP or HTTPS, if you select HTTPS, the following window appears. Enter the **Hostname/IP Address**, **HTTP Port**, and **HTTPS Port**. Click **Next.**
    ...
    Based on the inputs provided in the previous  [HTTP or HTTPS  >  a](Installing_VoltMX_Foundry_on_Windows.html#Step10a)  or  [HTTP or HTTPS  >  b](Installing_VoltMX_Foundry_on_Windows.html#Step10b), one of the following error messages appears:
