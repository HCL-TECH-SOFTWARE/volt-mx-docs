...
{% highlight voltMx %}void <OfflineObjects>.drop(final HashMap<String, object>options, final VMXCallback callback)
{% endhighlight %}
...
{% highlight voltMx %}void <OfflineObjects> drop:(NSDictionary \*) options onSuccess: VMXSuccessCompletionHandler)OnSuccess  
