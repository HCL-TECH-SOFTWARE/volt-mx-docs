...
{% highlight voltMx %}<object>.deleteByPK(options, onSuccessCallback, onFailureCallback)
{% endhighlight %}
...
*   Supported in iOS and Android platforms from V8 SP2 onwards.  
*   Supported in Mobile and Desktop Web channels from V8 SP4 onwards.  
