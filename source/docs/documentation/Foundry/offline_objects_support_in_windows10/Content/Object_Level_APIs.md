...
{% highlight voltMx %}<VMXObj>.startSync (syncOptions, successCallback, failureCallback)
{% endhighlight %}
...
{% highlight voltMx %}<VMXObj>.deleteByPK(options, successCallback, failureCallback)
{% endhighlight %}
