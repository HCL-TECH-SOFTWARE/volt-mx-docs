...
For installation of VoltMX Foundry V9 SP1 on Azure, refer to [VoltMX Foundry V9 SP1 on Azure](VoltMX Foundry on Azure.html).
...
Specify the following parameters in the **trial.properties/enterprise.properties** file to enable **Autoscaling**. For more information on Autoscaling refer to, [AKS Autoscaling](Appendices.html#Autoscaling).
