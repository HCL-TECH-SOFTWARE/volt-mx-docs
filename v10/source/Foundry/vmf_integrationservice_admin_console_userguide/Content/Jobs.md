...
| View Job History | View the history of the selected job. For detailed information on Job History page, refer [here](#view-job-history). |
...
![](Resources/Images/Adding_job.png)
...
> **_Note:_** When a job is scheduled or its state changes from inactive to active, the associated service is triggered once before the job schedule is performed.
