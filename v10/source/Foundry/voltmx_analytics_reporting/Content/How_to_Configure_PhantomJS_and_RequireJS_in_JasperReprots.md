How to Configure Chromium JS Engine to Download Reports in PDF Format - JasperReports Server V 8.2.0                        
-----------------------------------------------------------------------------------------------------
If you are using JasperReports Server  V8.2.0/7.9.2, to download/export reports in PDF format, you must need to configure the Chromium JavaScript engine into the JasperReports Server.
