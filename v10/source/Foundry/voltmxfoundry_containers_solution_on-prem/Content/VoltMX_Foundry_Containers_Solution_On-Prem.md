...
2.  Supports deployment in Linux (RHEL 9).
...
Foundry Kubernetes cluster is supported on RHEL 9.
...
All the Docker images built for Volt MX Foundry are built using the Tomcat version 9.0.107-jdk11 as the base image.
...
2.  Download Foundry container artifacts from [VoltMX Downloads](https://my.hcl-software.com/downloads/voltmx/foundrycurrent).
...
The docker images will be pulled when you execute the installation scripts in the "HCL Volt MX Foundry Container Installer" found on HCL's MHS [download website](https://my.hcl-software.com/downloads/voltmx/foundrycurrent/10.0.0) 
...
1.  Download the **VoltMXFoundryContainersOnPrem-9.0.0.0_GA.zip** from the [My HCLSoftware](https://my.hcl-software.com/downloads/voltmx/foundrycurrent) and extract it.
    ```
...
1.  Download the **voltmx-foundry-containers-onprem_9.0.0.0_GA.zip** from the [My HCLSoftware](https://my.hcl-software.com/downloads/voltmx/foundrycurrent) and extract it.
    ```
    sudo unzip VoltMXFoundryContainersOnPrem-9.0.0.0_GA.zip
        -d VoltMXFoundryContainerOnPrem-9.0.0.0_GA
    ```
