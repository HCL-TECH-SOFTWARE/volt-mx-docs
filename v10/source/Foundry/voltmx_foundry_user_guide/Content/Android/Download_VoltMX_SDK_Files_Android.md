...
2.  Save the `HCLVoltFoundry-android-sdk.zip` file in your local system.
3.  Extract the `HCLVoltFoundry-android-sdk.zip` file that you just downloaded.

    The ``HCLVoltFoundrySDK`` folder contains the following files:

    - kony_sdk-release.aar
    - kony-sdk.doc
    - LICENSE.txt
    - Version.txt
