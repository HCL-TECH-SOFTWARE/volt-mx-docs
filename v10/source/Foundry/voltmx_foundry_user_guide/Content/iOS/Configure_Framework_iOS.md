...
1.  [Configuring KonySDK.xcframework to Project](#configuring-voltmxsdk-framework-to-project)
2.  [Adding Framework Dependencies](#adding-framework-dependencies)
3.  [Installing com.kony.KonySDK.docset in Xcode](Installing.md)
...
1.  Extract the downloaded  `HCLVoltFoundry-ios-sdk.zip` file.
