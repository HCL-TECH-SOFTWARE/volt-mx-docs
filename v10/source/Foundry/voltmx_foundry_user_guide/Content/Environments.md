...
>**Note:** Only users with the Admin and higher role can enable or disable governance for a given environment.
...
>**Note**: Governance is not applicable for Native Publish.

>**Note**: Governance is <b>only applicable for single-tenant Foundry</b> environment

Refer [here](https://help.hcl-software.com/voltmx/v10/Foundry/voltmx_foundry_user_guide/Content/Governance_for_Foundry.html?h=govern#governance-for-an-environment) for setting Governance for an Environment
