...
Using **Settings**, a superuser can manage tasks by configuring identity providers, adding users, importing new users and groups, assigning roles to users, deleting users and groups, configuring a proxy server, configuring reports server and configuring mail server details for governance email support.
...
*   [Proxy](#proxy)
*   [Reports](#reports)
*   [Governance Email Settings](#governance-email-settings)

For more information about Governance click [here](https://help.hcl-software.com/voltmx/v10/Foundry/voltmx_foundry_user_guide/Content/Governance_for_Foundry.html)
...
Governance Email Settings
--------------------------

This section allows superusers(Owners/Admins) to set up outbound email settings for governance-related notifications. These settings enable the platform to send emails when a request is created, approved, declined or cancelled using the configured SMTP/SMTPS 
...
<table>
  ...
  <tr>
    <td>Protocol</td>
    <td>Protocol to be used for sending emails:
	<li>SMTP (default)</li>
    <li>SMTPS (for secure transmission) </li>
    </td>
  </tr>
  <tr>
    <td>Hostname</td>
    <td>Hostname or IP address of your email server.</td>
  </tr>
  <tr>
    <td>Port</td>
    <td>Port used by the email server</td>
  </tr>
  <tr>
    <td>Default Sender id </td>
    <td>Default sender email address that will appear in outgoing emails</td>
  </tr>
  <tr>
    <td>Security Mode</td>
    <td>Encryption mode for communication:
    <li>None</li>
    <li>SSL</li>
    <li>TLS</li>
    </td>
  ...
  <tr>
    ...
    <td>Indicates whether the server requires authentication. If “Yes” is selected, additional credentials fields like Username and Password may appear for configuration.
</td>
  </tr>
</table>
</body>
