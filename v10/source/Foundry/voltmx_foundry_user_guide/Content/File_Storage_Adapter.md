...
> **_Note:_**  
This topic describes the default File Storage adapter for Volt MX Foundry, also known as CloudFSA. This feature is available only in cloud environments and is not supported in on-premises deployments. To connect to a custom S3 bucket, see [AWS S3 Adapter](AWS_S3_Adapter.md).
