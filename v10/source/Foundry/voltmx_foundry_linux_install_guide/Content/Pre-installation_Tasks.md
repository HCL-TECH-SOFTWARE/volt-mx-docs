...
*   Download `VoltMXFoundrySetup.tar.gz` file from [MHS Portal](https://my.hcl-software.com/downloads/voltmx/foundrycurrent) and extract the file. To download Volt MX Foundry installer from the community portal, follow these steps:
    1.   Log in to [Downloads](https://my.hcl-software.com/downloads/voltmx/foundrycurrent). You can obtain a user name and password from your sales representative or partner.
