...
<ul>
<li><b>Cascade Delete</b> is enabled if the option is checked in <b>VoltMX
Foundry Console >> Object Services >></b> under configuring
relationships in a data model. When this option is enabled, the child records are deleted recursively along with the parent record. This option is applicable for all platforms except for SPA/Desktop Web channels of Volt MX Iris</li>
