...
<li>To use the getBinary API in Desktop Native, enable VoltMXIO NFI:
<ul>
<li>Navigate to <b>Edit -> Open Manage Native Function API(s).</b></li>
<li>Select the <b>Desktop</b> tab.</li>
<li>Enable <b>VoltMXIO.</b></li>
</ul></li>
</ol>
</blockquote>
