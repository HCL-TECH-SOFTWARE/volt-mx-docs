...
| 2486 | Invalid removeAfterUpload list. It contains one or more objects that do not exist. | This error code is thrown when user provides invalid object names to the list of removeAfterUpload sync option. |
