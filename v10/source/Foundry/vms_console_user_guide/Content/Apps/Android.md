...
1.  **FCM Project URL and Service Account Key**: Enter the **FCM Project URL** and upload the **Service Account Key**
    ...
    > **Note:**      
    *   Click the **[Generating Firebase Cloud Messaging (FCM) Project URL, Service Account key and Sender ID](Generating_the_Global_Cloud.md)** link for more details on how to subscribe for FCM Authorization Key.    
...
2.  Click **Test Connectivity** button to check if the **FCM** Project URL and Service Account Key is valid or not.  
