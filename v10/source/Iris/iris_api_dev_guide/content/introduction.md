...
*   **[Credential Manager API](Overview.md)**: The Credential Manager API functions provides support for Passkey. The namespace is **voltmx.credentialmanager**.
    *   **[Passkey API](Passkey_Overview.md)**: Passkey APIs provide support for registering & signing in with Passkeys. They are part of Credential Manager APIs.
...
*   **[NFC API](Near_Field_Communication_API.md)**: The NFC API provides the standard interface to read and write the data to NFC tags. 
