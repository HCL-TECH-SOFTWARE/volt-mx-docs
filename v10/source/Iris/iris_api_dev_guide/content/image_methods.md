...
```
Sample Code for DesktopNative and DesktopWeb:

```

var imgObj = voltmx.image.createImageFromSnapShot(this.view.img1);
var rawBytes = imgObj.getImageAsRawBytes();
this.view.img3.rawBytes = rawBytes; 
```
...
Available on iOS , Android, Desktopweb and DesktopNative.

>**Note:** For DesktopWeb and DesktopNative platforms, the image source in the Image object must use a base64 string format.
