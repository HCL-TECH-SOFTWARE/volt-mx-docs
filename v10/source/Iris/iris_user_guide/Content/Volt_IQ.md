...
<b>Volt AI</b> is a generative AI chatbot that delivers contextual responses using Volt MX documentation.

It is part of <b>Volt IQ</b> suite and appears as the first available option. 

Volt AI is integrated into Volt IQ and available to all logged-in users. 

You can also access it through other existing channels, including <b>Community</b>, <b>Marketplace</b>, <b>Hikes</b>, and <b>Youtube</b>.

Below are some of the key features of Volt AI.

### Key features of Volt AI include:

<ul><li><b>Comprehensive answers</b>: Volt AI answers questions about Volt MX and includes relevant links to documentation.</li>
<li><b>Script generation</b>: Volt AI generates Volt scripts on demand.</li>
<li><b>Multi-Platform support</b>: Volt AI also answers questions about LEAP, Go, and Domino if you are entitled to use these products.</li>
<li><b>Rate limiter</b>: Volt AI has a daily usage limit. When the limit is reached, it displays the message <i>Rate limit exceeded. Try again later</i>.</li>
<li><b>Access control</b>: Volt AI is available to only logged in users of Volt IQ.</li></ul>

### Accessing and Using Volt AI

1. Refer to the following images to get started with Volt IQ. The Volt IQ window appears as shown and is consistent with previous Iris releases.

     ![](Resources/Images/Fig1VoltIQstartingwindow.png)

2. When you ask a question, Volt IQ displays answers through multiple sources simultaneously, as shown in the image below. <br>The response under Volt AI is generated by the AI.

    ![](Resources/Images/Fig2VoltAIanswerswithcommunityandmarketplace.png)<br>
    ...
    > **_Note_**: To get answers from a specific channel, include the channel name in your question using the **@** symbol.<br>For example:<ul><li>@VoltAI How do I reset my password?</li><li>@Community What are common troubleshooting steps?</li><li>@Marketplace Are there any new plugins available?</li></ul>

3. For code generation queries, the chatbot first provides a brief explanation, followed by the code snippet, as shown in the image below. To copy the code, select the copy icon in the top-right corner of the snippet.

    ![](Resources/Images/Fig3Codesnippetwithbreifnote.png)

4. Volt AI also provides an explanation after the code snippet, as shown in the image below.

    ![](Resources/Images/Fig4Explanatoinoncodesnippet.png)

5. To provide feedback on a response, select the  <b>Thumbs up</b> or <b>Thumbs down</b> icon at the end of the answer, as shown in the image below.

    ![](Resources/Images/Fig5.png)

    > **_Note_**: Answers generated from AI models may not always be accurate. We recommended you, to verify the information before relying on it. 

6. To ask about products other than.<b>Volt MX</b>, include the product name in your question.<br>
For example, <i>How to create a form in Domino?</i>.

     ![](Resources/Images/fig6.png)

### Important Considerations

<ul><li>If you ask a question that is outside the chatbot’s scope or if the requested information is unavailable, Volt AI responds with: 

<br><i>I'm sorry, but the provided context does not contain specific information about the topic.</i><br>

<li>Code generation results may vary based on how you phrase your question. For more accurate results, ask questions in a clear and simple manner.</li></ul>
