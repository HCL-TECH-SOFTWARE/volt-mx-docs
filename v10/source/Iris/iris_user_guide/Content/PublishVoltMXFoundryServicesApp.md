...
Publishing with Governance Enabled
-----------------------------------

When Governance is enabled for the selected environment, Developers must submit a review request instead of deploying the app directly. The request gets queued for review and approval by an Approver or Admin before the app can be deployed.
...
4. Review the changes and enter Comments for the request. Click Submit.
    ...
    >**NOTE:** All Foundry app services published till now will be shown as a change under the diff viewer in the first publish review request.
...
6. Once the request is approved, click Deploy Changes to deploy the app.
    ...
    >**Note:** App changes cannot be directly deployed to Governance enabled environments.
...
5. Choose to Approve or Reject the request and enter a comment.
...
6. Upon approval, the app is ready to be deployed by the developer. If rejected, the submitter is notified with the reason.

7. Approved or rejected requests can be viewed under the Closed Review Requests tab.


    ![](Resources/Images/Governance-16.jpg)

For more information click [here](https://help.hcl-software.com/voltmx/v10/Foundry/voltmx_foundry_user_guide/Content/Governance_for_Foundry.html)
...
Learn more on Raising and reviewing requests with Governance [here](https://help.hcl-software.com/voltmx/v10/Foundry/voltmx_foundry_user_guide/Content/Governance_for_Foundry.html).
