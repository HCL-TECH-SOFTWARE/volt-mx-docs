...
2. Type your Volt MX account login credentials, and click <b>Sign in.</b>

3. Under HCL Volt Iris, two flavors of installers are available for macOS, namely “Installer_Apple (ARM)” for Apple Silicon and “Installer_Apple (x86)” for Apple x86 (Intel) machines. Click the <b>Download</b> button for the installer of choice. The installer is downloaded as a zip file to your computer.



![](Resources/Images/v10.png)
