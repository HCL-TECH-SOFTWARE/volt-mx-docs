...
On iPhone and Android platforms, if this property is set to true, the following are applicable:
...
The default value for Browser widget is Constants.WRITING_TOOLS_BEHAVIOR_LIMITED.
...
//At the time of creation of Browser widget

var browser1 = new voltmx.ui.Browser({ 
    ...
    "writingTools Behavior": constants.WRITING TOOLS_BEHAVIOR_NONE;
});
```

> **_Note:_** writingToolsBehavior property cannot be modified at run time for Browser widget.
