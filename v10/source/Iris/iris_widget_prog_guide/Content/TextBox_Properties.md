...
In order to provide autocompletion, users need to set the **autoCompleteType** along with **autoComplete**.

**autoCompleteType**: It sets the name attribute inside the textbox widget for which the user needs to enable autocomplete, based on the value provided in the autocomplete field.<br>
**autoComplete**: There are three value can be set inside the autoComplete: **true/ false / token-list** 

The `<token-list>` options include:

<ul><li><a href= "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/autocomplete#named_groups">Group naming token</a></li>
<li><a href= "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/autocomplete#grouping_identifier">Grouping identifier</a></li>
<li><a href= "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/autocomplete#detail_tokens">Detail tokens</a></li>
<li><a href= "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/autocomplete#web_authorization_token">Web authorization</a></li></ul>
...
frmTxtBox.myTxtBox.autoCompleteType = "username"
...
*   Android, iOS,SPA , and Desktop web
...
For Android platforms, this property is applicable only if the [_autoFilter_](#autoFilt) property is set to _true_.
...
*   constants.TEXTBOX\_KEY\_BOARD\_STYLE\_NUMBER\_PAD: Specifies the keyboard to enter numbers.
    ![](Resources/Images/keyty-phn_205x135.png)  

    
*   constants.TEXTBOX\_KEY\_BOARD\_STYLE\_PHONE\_PAD: Specifies the keyboard to enter phone numbers.
...
```
>**Note:** When textInputMode is set to "numeric" for SPA, DesktopWeb, and DesktopNative platforms:<li>Only digits (0–9) are allowed.</li><li>If any non-numeric character is entered (e.g., e, - etc), the input will be automatically cleared.</li><li>Input is limited to the configured maxTextLength. any digits beyond this limit will be trimmed.</li>
...
> **_Note:_** You can set the placeholder text from the code only on iPhone and Android
...
> **_Note:_** Android support change in font color only.
...
### <details close markdown="block"><summary>writingToolsBehavior Property</summary>

* * *

This property enables writing tools experience to support the current view.
...
The default value for TextBox is Constants.WRITING_TOOLS_BEHAVIOR_DEFAULT.

Following are the constant values available:

*   constants.WRITING_TOOLS_BEHAVIOR_NONE: This constant value prevents the writing tools from modifying the text in the view.
*   constants.WRITING_TOOLS_BEHAVIOR_DEFAULT: This constant value lets the system determine the best way to enable writing tools for the view.
*   constants.WRITING_TOOLS_BEHAVIOR_COMPLETE: This constant value provides the complete writing tools experience for the text view.
*   constants.WRITING_TOOLS_BEHAVIOR_LIMITED: This constant value provides a limited, overlay-panel experience for the text view.

> **_Note:_** This property is only supported on Apple Intelligence supported devices and regions.

**Example**

```

//Updating writingToolsBehavior at run time
//For textbox widget

Form1.textbox1.writingToolsBehavior = constants.WRITING_TOOLS_BEHAVIOR_COMPLETE;
```
