...
```
    {
        "imageWidgetURLCache":
        {
            ...
            // true - For once cached, no need to sync with server again to check the updated resource.
            // false - To Sync with the server to check for the updated resource.
        }  
    }    
```
<html>
...
<ol start="4">
  <li>Save and close the file<br>  
    Image caching is enabled in the Volt MX cache mechanism.</li>
</ol>
</body>
</html>
