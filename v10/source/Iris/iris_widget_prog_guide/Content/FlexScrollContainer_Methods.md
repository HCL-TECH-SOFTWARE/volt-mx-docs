...
FlexScrollContainer Methods
===========================

FlexScrollContainer widget has the following methods associated with it:
...
```
 ...
 myFlexScrollContainer.setDefaultUnit(voltmx.flex.DP);
 //myFlexScrollContainer.add();
 Form1.add(myFlexScrollContainer);
}
```
...
```
    ...
    Form1.flx1.addAt(btn1, 1); //flx1 is a flexcontainer inside the form. 
}
...
(Mandatory): Specifies the position in number format.Following are the options:
