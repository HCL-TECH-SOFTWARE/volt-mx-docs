...
<b>Name the NFI</b>, assign a <b>version</b>, and provide a <b>namespace</b> for the API.

If your NFI requires Node.js modules or native binaries, upload a `.json` file using the <b>Add Dependencies (.json)</b> field.
...
> **_Note:_**   Windows and MacOS settings input fields should follow npm standards.
